MateriaFrameGenerate<-function(GearSetFilePath=file.choose(),MajorMateriaValue=36,MinorMateriaValue=12){
  print('Warning: You should see this message exactly ONCE')
  GearFrame<-Gearframe_Generate(GearSetFilePath,MajorMateriaValue,MinorMateriaValue)
